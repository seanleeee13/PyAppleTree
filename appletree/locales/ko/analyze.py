translate_data = {
    ...
    "analyze_sample_rate_3": "<orange><bold>점유율: %(sample_rate).1f%%<end>",
    ...
    "analyze_cumulative_rate_3": "<orange><bold>, 스택 점유율: %(cumulative_rate).1f%%<end>",
    ...
    "analyze_magnification_3": "<orange><bold>, 증폭률: %(magnification).1f<end>",
